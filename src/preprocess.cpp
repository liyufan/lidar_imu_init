...
void Preprocess::process(const CustomMsg::ConstPtr &msg, PointCloudXYZI::Ptr &pcl_out) {
    avia_handler(msg);
    *pcl_out = pl_surf;
}

void Preprocess::process_cut_frame_livox(const CustomMsg::ConstPtr &msg,
...
void Preprocess::avia_handler(const CustomMsg::ConstPtr &msg) {
    pl_surf.clear();
    pl_corn.clear();
    pl_full.clear();
